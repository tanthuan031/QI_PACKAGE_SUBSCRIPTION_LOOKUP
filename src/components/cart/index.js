        ...
        <div className="container  ">
          ...
          {dataCart.length > 0 ? (
            ...
            >
              <div className="container">
                <div className="row">
                  <div className="col-xl-7 col-sm-12 col-12 mb-5">
                    <div
                      style={{
                        background: "#fff",
                        borderRadius: "10px",
                    ...
                    >
                      <h5 className="text-center mb-4 "> Danh sách gói cước</h5>
                      <div
                        style={{
                          maxHeight: "400px",
                          overflowY: "auto",
                  ...
                  <div className="col-xl-5 col-sm-12 col-12 mb-5">
                    <div
                      style={{
                        background: "#fff",
                        borderRadius: "10px",
                ...
                >
                  <h5 className="text-center mb-4 ">Thông tin khách hàng</h5>
